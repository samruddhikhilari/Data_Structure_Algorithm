...
public class path_from_start_nochild {
    ...
    public void printPath(int start, boolean visited[], String path) {
    ...
    public static void main(String[] args) {
        ...
        int n = 5;
        path_from_start_nochild b1 = new path_from_start_nochild(n);
